...
export default {
   setup(props, { emit }) {
    ...
    const handleRightClick = () =>{
      ...
      if (ContactPerson.value && CorrectContactPerson.value && organization.value && CorrectOrganization.value && MailAddress.value && CorrectMailAddress.value && ContactTelephone.value && CorrectContactTelephone.value && CorrectFaxNumber.value && FaxNumber.value && email.value && CorrectEmail.value && country.value && city.value) {
