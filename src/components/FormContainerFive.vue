...
export default {
  setup(prop, { emit }) {
    ...
    const handleRightClick = () => {
      ...
      if (yLl.value && CorrectYLl.value && xLl.value && CorrectXLl.value && yLr.value && CorrectYlr.value && xLr.value && CorrectXlr.value && xUl.value && CorrectXUl.value && yUl.value && CorrectYUl.value && xUr.value && CorrectXUr.value && yUr.value && CorrectYUr.value) {
